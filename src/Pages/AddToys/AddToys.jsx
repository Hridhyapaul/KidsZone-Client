    ...
    return (
        <div className='max-w-[1100px] lg:mx-auto'>
            <div className="text-center lg:text-center mt-8">
                <h1 className="lg:text-5xl text-2xl font-bold">Add Your <span className='text-[#D268CC]'>Products</span></h1>
            </div>
            <div className="w-full bg-base-100 mt-0 lg:mt-8">
                <div className="card-body lg:px-0 ">
